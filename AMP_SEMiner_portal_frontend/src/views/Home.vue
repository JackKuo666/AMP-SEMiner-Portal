  ...
  <div class="article-home">
    <el-container>
      ...
      <el-header class="header">
        <div class="logo">
          <span class="portal-title">MAG-AMPome</span>
          <small class="portal-subtitle">A Data Portal for Antimicrobial Peptides from Metagenome-Assembled Genomes</small>
        </div>
      </el-header>
        ...
        <el-row class="portal-row">
          <el-col>
            <el-card class="portal-card" shadow="hover" :body-style="{ padding: '20px' }">
              ...
              <p class="section-text">Unveiling the Evolution of Antimicrobial Peptides in Gut Microbes via Foundation Model-Powered Framework.</p>
            </el-card>
          </el-col>
        </el-row>
      ...
      <el-footer class="footer">
        <p>© 2024 AMP SEMiner authors. The portal open source code is available in <a href="https://github.com/JackKuo666/AMP-SEMiner-Portal" target="_blank" rel="noopener noreferrer" class="blue-link">this link</a>.</p>
      </el-footer>
    </el-container>
  </div>
</template>
